...
public class SingletonTest {
  ...
  public static String serializeObject(Object o) throws Exception {
    String realPath = SingletonTest.class.getResource("/").getPath()
        .concat(o.getClass().getSimpleName());
   ...
   * @param clazz
   */
  public static void reflectTest(Class clazz) throws NoSuchMethodException, IllegalAccessException,
  ...
  public static void deSerializeEagerSingletonTest() throws Exception {
    ...
    System.out.println(
        "single:" + System.identityHashCode(singleton) + "\t o:" + System.identityHashCode(o));
  }
