...
3. 行为型：Interpreter(解释器)、Template Method(模板方法)、Chain of Responsibility(责任链)、Command(命令)、Iterator([迭代器](doc/Iterator.md))、Mediator([中介者](doc/Mediator.md))、Memento([备忘录](doc/Memento.md))、Observer([观察者](doc/Observer.md))、State([状态](doc/State.md))、Strategy(策略)、Visitor(访问者)
