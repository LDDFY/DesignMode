...
2. 结构型：Adapter Class/Object([适配器](doc/Adapter.md))、Bridge([桥接](doc/Bridge.md))、Composite([组合](doc/Composite.md))、Decorator(装饰)、Facade(外观)、FlyWeight(享元)、Proxy([代理](doc/Singletone.md))
